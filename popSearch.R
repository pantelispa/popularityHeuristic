...
runOneCondition <- function(cond, parameterSpace, optThresholds){
  ...
  # vars: parSetID, iterBigLoop, agent, memDRounds, maxDynamic, memChoice, memUncer, differ, highestUtility
...
save(parameterSpace, results, resultsDetailed, file = "popSearch.RData")
